'''
  ...
  @ FilePath: /EasyMocapPublic/easymocap/dataset/config.py
    ...
    # SOURCE: EasyMOCAP repository config.py file

    # NOTE: This file is not used in the codebase. It is a part of the original EasyMOCAP repository.
    #       The file is included here for reference purposes only.
    https://chingswy.github.io/easymocap-public-doc/quickstart/keypoints.html#yolov4hrnet
'''
import numpy as np
